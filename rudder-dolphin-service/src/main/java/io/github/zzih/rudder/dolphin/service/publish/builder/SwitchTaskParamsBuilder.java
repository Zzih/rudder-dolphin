...
/** Pass-through into DS {@link SwitchParameters}. */
@Component
...
public class SwitchTaskParamsBuilder implements TaskParamsBuilder {
    ...
    @Override
    public SwitchParameters build(Map<String, Object> source, TaskType type) {
        return objectMapper.convertValue(source, SwitchParameters.class);
    }
}
