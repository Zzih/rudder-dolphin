...
/**
 * rudder SubWorkflowTaskParams → DS SubWorkflowParameters
 * <p>
 * rudder: { workflowDefinitionCode: 123 }
 * DS:     { workflowDefinitionCode: 123, localParams: [] }
 */
@Component
public class SubWorkflowTaskParamsBuilder implements TaskParamsBuilder {
    ...
    public Map<String, Object> build(Map<String, Object> taskParams, String subType) {
        Object workflowDefinitionCode = taskParams.get("workflowDefinitionCode");
        if (workflowDefinitionCode == null) {
            throw new BizException(PublishErrorCode.INVALID_TASK_DEFINITION,
                    "Sub-workflow task 'workflowDefinitionCode' is required");
        }

        Map<String, Object> ds = new LinkedHashMap<>();
        ds.put("workflowDefinitionCode", ((Number) workflowDefinitionCode).longValue());
