...
/**
 * rudder ConditionTaskParams → DS ConditionsParameters
 * <p>
 * rudder: { dependence: {...}, conditionResult: { successNode: [...], failedNode: [...] } }
 * DS:     { dependence: {...}, conditionResult: { successNode: [...], failedNode: [...] }, localParams: [] }
 */
@Component
public class ConditionTaskParamsBuilder implements TaskParamsBuilder {
    ...
    public Map<String, Object> build(Map<String, Object> taskParams, String subType) {
        Object conditionResult = taskParams.get("conditionResult");
        if (conditionResult == null) {
            throw new BizException(PublishErrorCode.INVALID_TASK_DEFINITION,
                    "Condition task 'conditionResult' is required");
        }

        Map<String, Object> ds = new LinkedHashMap<>();
        ds.put("dependence", taskParams.getOrDefault("dependence", Map.of()));
        ds.put("conditionResult", conditionResult);
