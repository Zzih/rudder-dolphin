...
public class HttpTaskParamsBuilder implements TaskParamsBuilder {

    private final ObjectMapper objectMapper;

    @Override
    public boolean supports(TaskType type) {
        return type == TaskType.HTTP;
    }

    @Override
    public HttpParameters build(Map<String, Object> source, TaskType type) {
        return objectMapper.convertValue(source, HttpParameters.class);
    }
}
