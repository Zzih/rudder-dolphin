...
package io.github.zzih.arion.dolphin.api.interceptor;

import io.github.zzih.arion.dolphin.common.enums.SystemErrorCode;
...
public class AuthInterceptor implements HandlerInterceptor {
    ...
    public AuthInterceptor(@Value("${arion-dolphin.auth.token:}") String authToken, ObjectMapper objectMapper) {
