...
import io.github.zzih.arion.dolphin.service.task.builder.*;
...
public enum ArionTaskType {
    ...
    public static ArionTaskType of(String name) {
        for (ArionTaskType type : values()) {
